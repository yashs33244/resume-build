        ...
        <div className={'template-container'} id={id}>
            <div className={'lp'}>
                <div className={'lp_personalInfo'}>
                    <div className={'lp_personalInfo_name'}>{resumeData?.personalInfo?.name}</div>
                    <div className={'lp_personalInfo_role'}>{resumeData?.personalInfo?.title}</div>
                </div>
                ...
                <div className={`${'lp_education_div'} ${'lp_container'}`}>
                    <div className={`${'lp_education_div_label'} ${'lp_container_header'}`}>
                        Education
                    </div>
                            ...
                            resumeData.education?.map((edu:any) => {
                                return(
                                    <div className={'lp_education_div_value_section'}>
                                        <div className={'lp_education_div_value_section_name'}>{edu?.degree + " - " + edu?.major + ", "+edu?.institution}</div>
                                        <div className={'lp_education_div_value_section_year'}>{edu?.start + " - " + edu?.end}</div>
                                    </div>
                                )
                            })
                        }
                    ...
                    <div className={`${'lp_skill_div_value'}`}>
                        {
                            resumeData?.coreSkills?.map((item:any)=>{
                                return(
                                    <div className={'lp_skill_div_value_item'}>{item}</div>
                                )
                            })
                        }
                        {
                            ...
                            resumeData.experience?.map((exp:any) => {
                                return(
                                    <div className={'rp_experience_div_value_section'}>
                                        <div className={'rp_experience_div_value_section_name'}>{exp?.company + " - " + exp?.role}</div>
                                        <div className={'rp_experience_div_value_section_year'}>{exp?.duration || (exp?.start + " - " + exp.end)}</div>
                                        <div 
