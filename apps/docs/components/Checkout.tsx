            ...
            <div className="content-container">
                ...
                <div className="right">
                    <div className="payment-packs">
                        <div onClick={() => handlePackSelection('30')} className={`pack-30 ${selectedPack === '30' ? 'selected' : ''}`}>
                            <div className="pack-type">Popular</div>
                            <div className="timeline">30 Days</div>
                            <div className="price">₹199</div>
                            <div className="pack-info">Good for Trial</div>
                        </div>
                        <div onClick={() => handlePackSelection('90')} className={`pack-90 ${selectedPack === '90' ? 'selected' : ''}`}>
                    ...
                    <div className="side-note">One time payment with 7-day money back guarentee</div>
                </div>
            </div>
        </div>
    )
