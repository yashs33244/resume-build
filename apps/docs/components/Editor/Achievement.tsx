...
interface AchievementProps {
  ...
  handleInputChange: (section: keyof ResumeProps, field: string, value: any) => void;
  handleDeleteField: (section: keyof ResumeProps) => void;
}

export const Achievement: React.FC<AchievementProps> = ({ resumeData, handleInputChange, handleDeleteField }) => {
  return (
    <div className="mt-8">
